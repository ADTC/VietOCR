...
namespace VietOCR.NET
{
    public partial class GUI : GUIWithRegistry
    {
        ...
        private void openToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            openFileDialog1.Filter = "All Image Files|*.bmp;*.gif;*.jpg;*.jpeg;*.png;*.tif;*.tiff|Image Files (*.bmp)|*.bmp|Image Files (*.gif)|*.gif|Image Files (*.jpg;*.jpeg)|*.jpg;*.jpeg|Image Files (*.png)|*.png|Image Files (*.tif;*.tiff)|*.tif;*.tiff|PDF Files (*.pdf)|*.pdf;|UTF-8 Text Files (*.txt)|*.txt";
