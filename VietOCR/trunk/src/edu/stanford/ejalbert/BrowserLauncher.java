/*
 *  Modified from the original file at http://browserlauncher.sourceforge.net/BrowserLauncher.java by
 *  incorporating the fixes suggested at http://sourceforge.net/tracker/?atid=114506&group_id=14506&func=browse
 *  and adding support for Mac OS X up to version 10.3
 *
 *  Gero Herrmann, October 31, 2003
 *
 *  Use Mozilla as the default browser for Unix/Linux, if Netscape does not exist
 *  
 *  Quan Nguyen, March 22, 2005
 *
 *  Use Firefox as the default browser for Unix/Linux, if Mozilla does not exist
 *  
 *  Quan Nguyen, June 21, 2007
 */
...
public class BrowserLauncher {
    ...
    /**
     *  JVM constant for Java 1.4.1 Update on Mac OS X 10.2.3 (MRJ 4.1)
     */
    private final static int MRJ_4_1 = 5;

    /**
     *  JVM constant for any Windows NT JVM
     */
    private final static int WINDOWS_NT = 6;

    /**
     *  JVM constant for any Windows 9x JVM
     */
    private final static int WINDOWS_9x = 7;
    ...
    static {
        ...
        if (osName.startsWith("Mac")) {
            String mrjVersion = System.getProperty("mrj.version") + "999";
            try {
                double version = Double.valueOf(mrjVersion.substring(0, 3)).doubleValue();
                if (version >= 4.1) {
        ...
        switch (jvm) {
            ...
            case OTHER:
                ...
                try {
                    ...
                    // Mozilla does not exist; try Firefox
                    browser = "firefox";
                    process = Runtime.getRuntime().exec(browser + " -remote openURL(" + url + ")");                        
                }                        
                }
    ...
    /**
     *  Method for testing openURL
     *
     *@param args    the URL to open for testing
     */
